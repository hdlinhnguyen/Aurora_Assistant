...
const WHITELIST: Spec[] = [
  ...
  { id: "l4-tinh-chat-phan-so", lop: 4, key: "tính chất cơ bản của phân số", ten: "Tính chất phân số — rút gọn, quy đồng", mo: false, row: 1, tienQuyet: ["l4-khai-niem-phan-so", "l4-nhan-chia-so-tu-nhien"] },
  ...
  // Nền móng số học + mầm đại số của lớp 4 (bổ sung 17/7 — vá gốc cho nhánh phương trình)
  { id: "l4-nhan-chia-so-tu-nhien", lop: 4, key: "phép nhân, phép chia", ten: "Nhân, chia số tự nhiên", mo: false, row: 4, tienQuyet: [] },
  { id: "l4-bieu-thuc-chu", lop: 4, key: "biểu thức số và biểu thức chữ", ten: "Biểu thức số & biểu thức chữ", mo: false, row: 5, tienQuyet: ["l4-nhan-chia-so-tu-nhien"] },
  ...
  // ---- Lớp 6 (THCS) — rà soát cuối 17/7: thêm luỹ thừa, ƯC-BC, khái niệm số nguyên ----
  { id: "l6-luy-thua", lop: 6, key: "các phép tính với số tự nhiên", ten: "Phép tính số tự nhiên & luỹ thừa", mo: false, row: 0, tienQuyet: ["l4-nhan-chia-so-tu-nhien"] },
  { id: "l6-uoc-boi", lop: 6, key: "tính chia hết trong tập hợp các số tự nhiên", ten: "Chia hết, số nguyên tố, ƯC–BC", mo: false, row: 1, tienQuyet: ["l4-nhan-chia-so-tu-nhien"] },
  { id: "l6-khai-niem-so-nguyen", lop: 6, key: "số nguyên âm", ten: "Số nguyên âm — khái niệm & thứ tự", mo: true, row: 2, tienQuyet: [] },
  { id: "l6-phep-tinh-so-nguyen", lop: 6, key: "các phép tính với số nguyên", ten: "Phép tính với số nguyên", mo: false, row: 3, tienQuyet: ["l4-nhan-chia-so-tu-nhien", "l6-khai-niem-so-nguyen"] },
  { id: "l6-phan-so-tinh-chat", lop: 6, key: "phân số. tính chất cơ bản của phân số", ten: "Phân số tử/mẫu nguyên & so sánh", mo: false, row: 4, tienQuyet: ["l5-quy-dong-phan-so", "l6-phep-tinh-so-nguyen", "l6-uoc-boi"] },
  { id: "l6-phep-tinh-phan-so", lop: 6, key: "các phép tính với phân số", ten: "Phép tính với phân số (mở rộng)", mo: false, row: 5, tienQuyet: ["l6-phan-so-tinh-chat", "l6-uoc-boi"] },
  ...
  { id: "l7-phep-tinh-so-huu-ti", lop: 7, key: "các phép tính với số hữu tỉ", ten: "Phép tính với số hữu tỉ", mo: false, row: 1, tienQuyet: ["l7-so-huu-ti-khai-niem", "l6-phep-tinh-phan-so", "l6-luy-thua"] },
  { id: "l7-can-bac-hai", lop: 7, key: "căn bậc hai số học", ten: "Căn bậc hai số học", mo: true, row: 2, tienQuyet: ["l7-phep-tinh-so-huu-ti"] },
  { id: "l7-so-thuc", lop: 7, key: "số vô tỉ", ten: "Số vô tỉ & số thực", mo: true, row: 3, tienQuyet: ["l7-can-bac-hai"] },
  { id: "l7-ti-le-thuc", lop: 7, key: "tỉ lệ thức và dãy tỉ số bằng nhau", ten: "Tỉ lệ thức & dãy tỉ số bằng nhau", mo: false, row: 4, tienQuyet: ["l7-phep-tinh-so-huu-ti", "l5-ti-so-phan-tram"] },
  // ---- Gói P1 (mở rộng đại số bản lề lớp 7–8, quyết định 17/7) ----
  { id: "l7-bieu-thuc-dai-so", lop: 7, key: "biểu thức đại số", ten: "Biểu thức đại số", mo: false, row: 5, tienQuyet: ["l7-phep-tinh-so-huu-ti", "l4-bieu-thuc-chu"] },
  { id: "l7-da-thuc-mot-bien", lop: 7, key: "đa thức một biến", ten: "Đa thức một biến", mo: false, row: 6, tienQuyet: ["l7-bieu-thuc-dai-so"] },
  { id: "l8-da-thuc-nhieu-bien", lop: 8, key: "đa thức nhiều biến", ten: "Đa thức nhiều biến", mo: false, row: 2, tienQuyet: ["l7-da-thuc-mot-bien"] },
  { id: "l8-hang-dang-thuc", lop: 8, key: "hằng đẳng thức", ten: "Hằng đẳng thức đáng nhớ", mo: false, row: 3, tienQuyet: ["l8-da-thuc-nhieu-bien"] },
  { id: "l8-phan-thuc-dai-so", lop: 8, key: "phân thức đại số", ten: "Phân thức đại số", mo: false, row: 4, tienQuyet: ["l8-da-thuc-nhieu-bien", "l6-phep-tinh-phan-so"] },
  // ---- Lớp 8–12 — node MỜ: kể chuyện xuyên cấp + cảnh báo chiều xuôi ----
  { id: "l8-phuong-trinh-bac-nhat", lop: 8, key: "phương trình bậc nhất", ten: "Phương trình bậc nhất", mo: false, row: 0, tienQuyet: ["l7-phep-tinh-so-huu-ti", "l7-da-thuc-mot-bien"] },
  ...
  { id: "l9-can-thuc", lop: 9, key: "căn bậc hai và căn bậc ba", ten: "Căn thức", mo: true, row: 0, tienQuyet: ["l7-can-bac-hai", "l7-so-thuc"] },
  { id: "l9-ham-so-y-ax2", lop: 9, key: "hàm số y", ten: "Hàm số y = ax²", mo: true, row: 1, tienQuyet: ["l8-ham-so-bac-nhat"] },
  { id: "l9-he-phuong-trinh", lop: 9, key: "phương trình và hệ phương trình bậc nhất hai ẩn", ten: "Hệ phương trình bậc nhất hai ẩn", mo: true, row: 2, tienQuyet: ["l8-phuong-trinh-bac-nhat"] },
  { id: "l9-phuong-trinh-bac-hai", lop: 9, key: "phương trình bậc hai một ẩn", ten: "Phương trình bậc hai", mo: true, row: 3, tienQuyet: ["l8-phuong-trinh-bac-nhat", "l8-hang-dang-thuc", "l9-can-thuc"] },
  ...
  { id: "l10-ham-so-bac-hai", lop: 10, key: "hàm số bậc hai", ten: "Hàm số bậc hai", mo: true, row: 1, tienQuyet: ["l10-ham-so", "l9-phuong-trinh-bac-hai", "l9-ham-so-y-ax2"] },
