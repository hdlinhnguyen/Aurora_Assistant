...
func main() {
	...
	teacherExams.Get("/students/:studentId/review-path", masteryHandler.GetTeacherReviewPath)
	...
	questionBank := api.Group("/teacher/question-bank", middleware.RequireRole("teacher", "admin"))
	questionBank.Get("/questions", questionBankHandler.ListQuestions)
	questionBank.Post("/questions", questionBankHandler.CreateQuestion)
	questionBank.Get("/questions/:questionId", questionBankHandler.GetQuestion)
	questionBank.Patch("/questions/:questionId", questionBankHandler.UpdateQuestion)
	questionBank.Delete("/questions/:questionId", questionBankHandler.DeleteQuestion)
	questionBank.Post("/questions/:questionId/rubric-items", questionBankHandler.CreateRubricItem)
	questionBank.Patch("/questions/:questionId/rubric-items/:rubricItemId", questionBankHandler.UpdateRubricItem)
	questionBank.Delete("/questions/:questionId/rubric-items/:rubricItemId", questionBankHandler.DeleteRubricItem)
	questionBank.Put("/questions/:questionId/rubric-items/reorder", questionBankHandler.ReorderRubricItems)

	questionBank.Get("/questions/:questionId/tagging-context", taggingHandler.GetContext)
	questionBank.Put("/questions/:questionId/topics", taggingHandler.SetQuestionTopics)
	questionBank.Put("/questions/:questionId/rubric-items/:rubricItemId/topics", taggingHandler.SetRubricItemTopics)
	questionBank.Get("/questions/:questionId/effective-topics", taggingHandler.GetEffectiveTopics)
	...
	api.Post("/feynman/score", tutorHandler.ScoreFeynmanExplanation)
	api.Post("/nodes/:nodeId/chat-theory", tutorHandler.ChatNodeTheory)
