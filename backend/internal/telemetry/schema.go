...
var eventRules = map[string]EventRule{
	...
	"learning_path_step_started":      {RequiredProperties: []string{"learning_path_id", "topic_id", "step_order", "status_before", "status_after", "attempt_count", "correct_count", "hint_count"}},
	"learning_path_step_progressed":   {RequiredProperties: []string{"learning_path_id", "topic_id", "step_order", "status_before", "status_after", "attempt_count", "correct_count", "hint_count"}},
	"learning_path_step_completed":    {RequiredProperties: []string{"learning_path_id", "topic_id", "step_order", "status_before", "status_after", "attempt_count", "correct_count", "hint_count"}},
	"learning_path_step_blocked":      {RequiredProperties: []string{"learning_path_id", "topic_id", "step_order", "status_before", "status_after", "attempt_count", "correct_count", "hint_count", "blocked_reason"}},
